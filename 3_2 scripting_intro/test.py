...
by_shop = data.groupby('shop_id').sum().drop(['item_id'], axis = 1)
...
data.to_sql('raw_sales', engine, if_exists= 'append', index = True)
by_item.to_sql('sales_by_item_index', engine, if_exists='append', index=True)
